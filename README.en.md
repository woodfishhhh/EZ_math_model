...
The repository does not vendor upstream contest papers or user files. Runtime-only content is placed under `skills/ez-math-model/external/` and ignored by git:
