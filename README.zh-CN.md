...
[English README](README.md) | [技能星图](STAR_MAP.md) | [SkillsMP](https://skillsmp.com)
...
EZ_math_model/
├── SKILL.md                 # skill 主入口
├── README.md                # 英文展示 README
├── README.zh-CN.md          # 中文展示 README
├── STAR_MAP.md              # 技能星图
...
仓库不内置上游优秀论文和用户私有材料。运行时内容放在 `external/`，并由 `.gitignore` 排除：

- `external/zhanwen-mathmodel/`：可选拉取的上游优秀论文。
- `external/user-corpus/`：用户自己的论文、教材、笔记和题解。
- `external/tools/`：本机工具启用决策。
